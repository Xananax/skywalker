...
,	text:/\.(txt|text|conf|def|list|log|in|md|markdown|css|stylus|less|sass|scss|html?|ejs|jade|haml|js|coffee|typescript|ts|ls|xml|json|csv|ini)$/i
...
,	script:/\.(js|coffee|typescript|ts|ls)$/i
